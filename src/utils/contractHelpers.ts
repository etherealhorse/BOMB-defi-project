...
import tokenSaleAbi from 'config/abi/tokenSale.json'
...
export const getCakeContract = (signer?: Signer | Provider) => {
  return getContract(cakeAbi, tokens.orb.address, signer) as Cake
}
...
export const getTokenSaleContarct = (signer?: Signer | Provider) => {
  return getContract(tokenSaleAbi, getTokenSaleAddress(), signer);
}